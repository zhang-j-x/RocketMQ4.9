...
public class MQClientInstance {
    ...
    /**生产者注册表 key: 组名 value: 生产者*/
    private final ConcurrentMap<String/* group */, MQProducerInner> producerTable = new ConcurrentHashMap<String, MQProducerInner>();
    /**消费者注册表 key: 组名 value:消费者*/
    private final ConcurrentMap<String/* group */, MQConsumerInner> consumerTable = new ConcurrentHashMap<String, MQConsumerInner>();

    private final ConcurrentMap<String/* group */, MQAdminExtInner> adminExtTable = new ConcurrentHashMap<String, MQAdminExtInner>();
    /**客户端网络层配置*/
    private final NettyClientConfig nettyClientConfig;
    /**核心api的实现 将MQ业务层数据转换为网络层 RemotingCommand 对象，然后使用nettyRemotingClient完成网络io*/
    ...
    /**broker地址表 key: brokerName value: broker信息 brokerId （0为master 1为slave） ->  ip:port */
    private final ConcurrentMap<String/* Broker Name */, HashMap<Long/* brokerId */, String/* address */>> brokerAddrTable =
        new ConcurrentHashMap<String, HashMap<Long, String>>();
    /**broker版本表 key: brokerName value: broker信息 ip:port -> 版本*/
    ...
    private void startScheduledTask() {
        ...
        this.scheduledExecutorService.scheduleAtFixedRate(new Runnable() {
            ...
            public void run() {
                try {
                    //从nameServer 更新客户端本地的路由数据 30s一次
        ...
        this.scheduledExecutorService.scheduleAtFixedRate(new Runnable() {
            ...
            public void run() {
                try {
                    //清理下线的broker节点 判断broker地址表brokerAddrTable 中的broker存在于客户端路由数据表topicRouteTable中
                    //如果不包含则需要删除
    ...
    public void updateTopicRouteInfoFromNameServer() {
        ...
        //遍历主题集合 从nameServer拉取最新的主题路由数据，与本地客户端的路由数据对比，判断是否需要更新
